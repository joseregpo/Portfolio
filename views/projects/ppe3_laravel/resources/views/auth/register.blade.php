            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="id_regions" class="col-md-4 col-form-label text-md-right">{{ __('Region') }}</label>

                            <div class="col-md-6">
                                <select name='id_regions' id="id_regions" class="form-control @error('Region') is-invalid @enderror">
                                    ...
                                    <option value="6">Caraibes-Ameriques</option>
                                    <option value="7">Asie-Afrique</option>
                                </select>
                                @error('Region')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
