//// Variables para El uso de la base de datos en staging o en local desde la api de laravel
//var URL_BASE = window.location.href.split('.com')[0]+'.com/server';
// var URL_BASE = 'http://staging.mlplak.com/server';
var URL_BASE = 'http://127.0.0.1:8000/api/CAD_Designer/';
...
$( window ).load(function() {
    ...
    var  t3 = new PointText( new Point(view.center));
    t3.content = " Luego Puedes seleccionar las caracteristicas de la linea que pertenece al grupo!"
    var  t4 = new PointText( new Point(view.center + 30));
    t4.content = "Listo ! Solo te queda clickear en cualquier parte del lienzo y arrastar el mouse para hacer una linea, No olvides de hacer click en dibujar linea ;)";
